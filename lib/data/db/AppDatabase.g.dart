    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `images` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `imagePath` TEXT NOT NULL)');
  ...
  _$ImageDao(
    ...
    this.changeListener,
        ...
        _imageEntityInsertionAdapter = InsertionAdapter(
            ...
            'images',
            (ImageEntity item) =>
                <String, Object?>{'id': item.id, 'imagePath': item.imagePath});
